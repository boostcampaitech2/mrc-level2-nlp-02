...
class WeightedLayerPoolingRobertaQA(RobertaPreTrainedModel):
    def __init__(self, model_name, config, layer_start: int = 4, layer_weights = None):
        super(WeightedLayerPoolingRobertaQA, self).__init__(config)
    ...
    def forward(
        ...
        # output[2] = all hidden states (if 'output_hidden_states': True) == past_key_value, tuple 형태로 반환
